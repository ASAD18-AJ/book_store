          ...
          <div className="  w-full lg:w-3/6   ">
            ...
            <div className="flex flex-col lg:flex-row justify-around bg-zinc-800 rounded p-12">
              ...
              />
              {
                ...
                <button className="bg-white rounded lg:rounded-full text-2xl lg:text-3xl p-3  text-red-500 flex items-center justify-center" onClick={handleFavourite}>
                  <FaHeart />{" "}
              ...
              )}
              {
                ...
                <button className="text-white rounded lg:rounded-full text-2xl lg:text-3xl p-3 lg:mt-8 md:mt-0 bg-white flex items-center justify-center">
                  <MdOutlineDelete/>
